...
简介：本技能基于国家卫生健康委发布的《药品临床综合评价质量控制指南（2024年版）》，实现药品的系统性、多维度综合评价。
支持：openclaw Claudecode技能使用。
严格遵循国家标准六维度评价体系：**安全性、有效性、适宜性、经济性、创新性、可及性**。 
核心特点  
- ✅ **国家标准**: 完全药品临床综合评价相关指南要求构建的skills 
